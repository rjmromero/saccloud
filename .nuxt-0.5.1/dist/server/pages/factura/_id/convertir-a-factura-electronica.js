...
// CONCATENATED MODULE: ./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/unplugin/dist/webpack/loaders/transform.js??ref--12-0!./pages/factura/_id/convertir-a-factura-electronica.vue?vue&type=template&id=12a39eea&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return _c('Content',{attrs:{"max-width":"624","padding":"24"}},[_c('Heading',{attrs:{"center":"","color":"white"}},[_vm._v("Convertir a factura electrónica")]),_vm._v(" "),_c('Label',{attrs:{"center":"","color":"white","is-upper":"","margin-bottom":"24"}},[_vm._v(_vm._s(_vm.bussiness))]),_vm._v(" "),_c('P',{attrs:{"center":"","color":"graylight","margin-bottom":"24"}},[_vm._v("Por favor ingrese el código de validación"+_vm._s(_vm.askForNIT ? ' y su identificación ' : ' ')+"para convertir a factura electrónica")]),_vm._v(" "),(_vm.isLoading)?_c('Loading'):_c('Grid',{attrs:{"align-items":"end","auto-fill":_vm.askForNIT ? '144' : '272',"gap":"16"}},[_c('Input',{attrs:{"bg":"black","color":"white","holder":"Código de validación"},model:{value:(_vm.dataSend.codigo_validacion),callback:function ($$v) {_vm.$set(_vm.dataSend, "codigo_validacion", $$v)},expression:"dataSend.codigo_validacion"}}),_vm._v(" "),(_vm.askForNIT)?_c('Input',{attrs:{"bg":"black","color":"white","holder":"Identificación/NIT/CC"},model:{value:(_vm.dataSend.nit),callback:function ($$v) {_vm.$set(_vm.dataSend, "nit", $$v)},expression:"dataSend.nit"}}):_vm._e(),_vm._v(" "),_c('Button',{attrs:{"disabled":!_vm.isValid,"is-fill":""},on:{"click":function($event){return _vm.fetchPost()}}},[_vm._v("Reclamar")])],1)],1)}
var staticRenderFns = []


// CONCATENATED MODULE: ./pages/factura/_id/convertir-a-factura-electronica.vue?vue&type=template&id=12a39eea&
...
// CONCATENATED MODULE: ./node_modules/babel-loader/lib??ref--2-0!./node_modules/@nuxt/components/dist/loader.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./node_modules/unplugin/dist/webpack/loaders/transform.js??ref--12-0!./pages/factura/_id/convertir-a-factura-electronica.vue?vue&type=script&lang=js&
...
__sfc_main.setup = (__props, __ctx) => {
  ...
  const bussiness = Object(runtime["f" /* ref */])('CARGANDO...');
  const askForNIT = Object(runtime["f" /* ref */])(false);
  const isLoading = Object(runtime["f" /* ref */])(false);
  Object(runtime["j" /* useFetch */])(async () => {
    try {
      const R = await $axios.$post('/iccloud/v1/login/ver-documento-codigo', {
        codigo: params.value.id
      });
  ...
  const isValid = Object(runtime["a" /* computed */])(() => {
    var _dataSend$codigo_vali, _dataSend$nit;

    return ((_dataSend$codigo_vali = dataSend.codigo_validacion) === null || _dataSend$codigo_vali === void 0 ? void 0 : _dataSend$codigo_vali.length) > 3 && ((_dataSend$nit = dataSend.nit) === null || _dataSend$nit === void 0 ? void 0 : _dataSend$nit.length) > 5;
  });
  ...
  async function fetchPost() {
    ...
    try {
      ...
      useAlert["a" /* Alert */].show({
        title: 'Error',
        message: `${message} (${(e === null || e === void 0 ? void 0 : (_e$response2 = e.response) === null || _e$response2 === void 0 ? void 0 : _e$response2.status) || -1})`,
        delay: 300
      });
      isLoading.value = false;
    }
...
/* harmony default export */ var convertir_a_factura_electronicavue_type_script_lang_js_ = (__sfc_main);
// CONCATENATED MODULE: ./pages/factura/_id/convertir-a-factura-electronica.vue?vue&type=script&lang=js&
 /* harmony default export */ var _id_convertir_a_factura_electronicavue_type_script_lang_js_ = (convertir_a_factura_electronicavue_type_script_lang_js_); 
// EXTERNAL MODULE: ./node_modules/vue-loader/lib/runtime/componentNormalizer.js
var componentNormalizer = __webpack_require__(3);

// CONCATENATED MODULE: ./pages/factura/_id/convertir-a-factura-electronica.vue
...
var component = Object(componentNormalizer["a" /* default */])(
  _id_convertir_a_factura_electronicavue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
/* harmony default export */ var convertir_a_factura_electronica = __webpack_exports__["default"] = (component.exports);

/* nuxt-component-imports */
installComponents(component, {Heading: __webpack_require__(55).default,Label: __webpack_require__(25).default,P: __webpack_require__(26).default,Loading: __webpack_require__(163).default,Input: __webpack_require__(145).default,Button: __webpack_require__(27).default,Grid: __webpack_require__(52).default,Content: __webpack_require__(54).default})


/***/ })

};;
//# sourceMappingURL=convertir-a-factura-electronica.js.map